...
#cov.plot()
wedge_test(lining = 'makePatches_ShadowQuilt_fromEdges',apexZ0=0,top_layer_cutoff=50, wedges=[0,4], z0_spacing=0.15, leftRightAlign=False, show_acceptance_of_cover=True, accept_cutoff=15)
