...
wedge_test(lining = 'makePatches_ShadowQuilt_fromEdges',apexZ0=0,top_layer_cutoff=50, wedges=[3, 4], ppl = 16, z0_spacing=0.2, leftRightAlign=False, show_acceptance_of_cover=True, movie = True, accept_cutoff=15, figSizeScale = 3)
