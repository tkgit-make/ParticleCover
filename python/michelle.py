...
wedge_test(lining = 'makePatches_ShadowQuilt_fromEdges',apexZ0=0,top_layer_cutoff=50, wedges=[0,6400], ppl = 16, z0_spacing=0.5, leftRightAlign=False, show_acceptance_of_cover=False, accept_cutoff=15)
