...
#wedge_test(lining = 'makePatches_ShadowQuilt_fromEdges',apexZ0=0,top_layer_cutoff=50, wedges=[0, 20], ppl = 16, z0_spacing=0.2, leftRightAlign=False, show_acceptance_of_cover=True, accept_cutoff=15, figSizeScale = 3)
...
minimal_cover_binary_search(lining = 'makePatches_Projective_center', z0_spacing=0.5, ppl =16, z_top=50, wedges=2, accept=0.999)
