...
wedge_test(lining = 'makePatches_ShadowQuilt_fromEdges',apexZ0=0,top_layer_cutoff=50, wedges=[7, 8], ppl = 16, z0_spacing=0.2, leftRightAlign=False, show_acceptance_of_cover=True, accept_cutoff=15)
