...
#cov.plot()
#wedge_test(lining = 'makePatches_ShadowQuilt_fromEdges',apexZ0=0,top_layer_cutoff=50, wedges=[0, 1], z0_spacing=0.5, leftRightAlign=False, show_acceptance_of_cover=True, accept_cutoff=15)
wedge_test(lining = 'makePatches_ShadowQuilt_fromEdges',apexZ0=0,top_layer_cutoff=50, wedges=[0, 100], ppl = 16, z0_spacing=0.2, leftRightAlign=False, show_acceptance_of_cover=True, movie = False, accept_cutoff=15, figSizeScale = 3)
#unaccepted_lines(uniform_points=70)
#minimal_cover_binary_search()
...
#minimal_cover_binary_search(lining = 'makePatches_Projective_center', z0_spacing=0.5, ppl =16, z_top=50, wedges=1, accept=0.999)
