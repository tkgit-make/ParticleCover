...
wedge_test(lining = 'makePatches_ShadowQuilt_fromCenter',apexZ0=0,top_layer_cutoff=50, wedges=[0,10], ppl = 16, z0_spacing=0.5, leftRightAlign=False, show_acceptance_of_cover=True, accept_cutoff=15)
